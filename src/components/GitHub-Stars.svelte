...
{#if !isNaN(stars) && owner && repo}
  <div class="mx-auto w-full border-b border-t px-2.5 pb-8 pt-16 md:px-20">
    <div class="mx-auto max-w-md text-center sm:max-w-xl">
      ...
      <p class="mt-5 text-white/50 sm:text-lg">Our source code is available on GitHub - feel free to read, review, or contribute to it however you want!</p>
    </div>
    <div class="flex items-center justify-center py-10">
      <a href={`https://github.com/${owner}/${repo}`} target="_blank" rel="noreferrer">
        <div class="flex items-center">
          <div class="flex h-10 items-center space-x-2 rounded-md border border-white/50 bg-gray-800 p-4">
            <svg xmlns="https://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" class="h-5 w-5 text-white">
              <path
          ...
          <div class="relative ml-[0.45rem] flex h-[2.5rem] items-center rounded bg-black p-[1rem]">
